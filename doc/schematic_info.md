...
| 功能 | 器件 / 接口 | MCU 连接 | 说明 |
| --- | --- | --- | --- |
| RS232-1 | U5 MAX3232，CN4 | PC10/TX1、PC11/RX1 | 3.3V MCU UART 转 RS232；当前固件不启用 USART3。 |
| RS232-2 | U5 MAX3232，CN6 | PA2/TX2、PA3/RX2 | 3.3V MCU UART 转 RS232；当前固件主通信接口，使用 USART2。 |
...
6. 当前固件使用 USART2 的 PA2/PA3 作为主通信接口；USART3 的 PC10/PC11 不启用。波特率、帧格式和协议由上位机定义。
